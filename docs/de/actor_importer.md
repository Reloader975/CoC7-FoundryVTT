...
Sie können den Spielfiguren Importer verwenden, um verschiedene Formen von NSC- oder Kreaturenblöcke aus Abenteuern zu importieren. Ebenso können Sie Spielercharaktere importieren, die aus dem JSON Export-Tool von [The Dholes House](https://www.dholeshouse.org/) stammen.
...
Falls Sie diese Funktion das erste Mal verwenden, lesen Sie bitte auch die folgenden Abschnitte zur näheren Erklärung.
